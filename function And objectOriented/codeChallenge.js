...
(function () {
    ...
    var Q1_birth = new Question(
        "what's my birth date?",
        ["1999.1.1", "1998.1.1", "1999.1.2"],
        1
    );
    var Q2_sport = new Question(
        "what's my favorite sport?",
        ["football", "swimming", "volleyball", "ping-pong"],
        1
    );
    var Q3_study = new Question(
        "I'm studing ... in university?",
        ["computer science", "software enginneer", "mechanic"],
        0
    );
    var Q4_footballTeam = new Question(
        "what's my favorite football team?",
        ["liverpool", "bayern", "realmadrid", "juventus"],
        2
    );
    ...
    function Newgame() {
        ...
        function get_answer() {
            var user_answer = prompt(
                "which answer is the correct? (just write the number)"
            );
            return user_answer;
        }
